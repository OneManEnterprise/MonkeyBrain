...
(async function() {
    ...
    String.prototype.includesOneOf = function(arrayOfStrings) {
        //console.info("String.prototype.includesOneOf ##########");

        //console.debug("arrayOfStrings: " + arrayOfStrings);
        //console.debug("!Array.isArray(arrayOfStrings: " + !Array.isArray(arrayOfStrings));

        //If this is not an Array, compare it as a String
        if (!Array.isArray(arrayOfStrings)) {
            console.debug("this.toLowerCase().includes(arrayOfStrings.toLowerCase()): " +this.toLowerCase().includes(arrayOfStrings.toLowerCase()));
            return this.toLowerCase().includes(arrayOfStrings.toLowerCase());
        }

        for (var i = 0; i < arrayOfStrings.length; i++) {
            //console.debug("arrayOfStrings[i]: " + arrayOfStrings[i]);
    ...
    String.prototype.equalsOneOf = function(arrayOfStrings) {
        //console.info("String.prototype.equalsOneOf ##########");
        ...
        //console.debug("this.toLowerCase(): " + this.toLowerCase());

        for (var i = 0; i < arrayOfStrings.length; i++) {
            //console.debug("arrayOfStrings[i]: " + arrayOfStrings[i]);
            //console.debug("arrayOfStrings[i].toLowerCase(): " + arrayOfStrings[i].toLowerCase());
            //console.debug("arrayOfStrings[i].substr(1).toLowerCase(): " + arrayOfStrings[i].substr(1).toLowerCase());
            //console.debug("this.toLowerCase() == arrayOfStrings[i].toLowerCase(): " + this.toLowerCase() == arrayOfStrings[i].toLowerCase());
    ...
    function matchImages(imageUrl, word, i) {
        //console.info("function matchImages ##########");
        ...
        GM_xmlhttpRequest({
            ...
            onload: function(response) {
                //console.info("imageidentify onload");
                clickImages(response, imageUrl, word, i)
            },
            onerror: function(e) {
                console.info("imageidentify onerror");
            ...
            ontimeout: function() {
                console.info("imageidentify ontimeout");
    ...
    function matchImagesUsingTensorFlow(imageUrl, word, i) {
        //console.info("function matchImagesUsingTensorFlow ##########");
    ...
    function matchImagesUsingTensorFlowMobileNet(imageUrl, word, i) {
        //console.info("function matchImagesUsingTensorFlowMobileNet ##########");
    ...
    function matchImageForVerticalRiver(imageUrl, word, i) {
        console.info("function matchImageForVerticalRiver ##########");
    ...
    function matchImagesUsingTrainer(imageUrl, word, i) {
        //console.info("function matchImagesUsingTrainer ##########");
    ...
    function clickImages(response, imageUrl, word, i) {
        //console.info("function clickImages ##########");
    ...
    async function getSynonyms(word) {
        //console.info("function getSynonyms ##########");
        //console.debug("word: " + word);
    ...
    function selectImagesAfterDelay(delay) {
        //console.info("function selectImagesAfterDelay ##########");
    ...
    function triggerEvent(el, type) {
        //console.info("function triggerEvent ##########");
    ...
    function triggerMouseEvent(el, type) {
        //console.info("function triggerMouseEvent ##########");
    ...
    function unsure(targetNodeText) {
        //console.info("function unsure ##########");

        //console.debug("targetNodeText: " + targetNodeText);
    ...
    function getUrlFromString(urlString) {
        //console.info("function getUrlFromString ##########");
    ...
    function getImageList() {
        //console.info("function getImageList ##########");
    ...
    function waitUntilImageSelection() {
        //console.info("function waitUntilImageSelection ##########");
    ...
    function waitForImagesToAppear() {
        //console.info("function waitForImagesToAppear ##########");
    ...
    function preProcessImage(base64Image, imageUrl) {
        //console.info("function preProcessImage ##########");
    ...
    function preProcessImageMethod2(base64Image, imageUrl) {
        //console.info("function preProcessImageMethod2 ##########");
    ...
    function preProcessImageMethod3(base64Image, imageUrl) {
        //console.info("function preProcessImageMethod3 ##########");
    ...
    function preProcessImageMethod4(base64Image, imageUrl) {
        //console.info("function preProcessImageMethod4 ##########");
    ...
    function postProcessImage(data) {
        //console.info("function postProcessImage ##########");
    ...
    function imageUsingOCR() {
        //console.info("function imageUsingOCR ##########");
    ...
    async function convertTextToImage(text) {
        //console.info("function convertTextToImage ##########");
    ...
    async function convertImageToText(img) {
        //console.info("function convertImageToText ##########");
    ...
    function areExampleImageUrlsChanged() {
        //console.info("function areExampleImageUrlsChanged ##########");
    ...
    async function identifyObjectsFromImages(imageUrlList) {
        //console.info("function identifyObjectsFromImages ##########");

        //console.debug("imageUrlList: " + imageUrlList);
    ...
    async function identifyObjectsFromImagesUsingMobileNet(imageUrlList) {
        //console.info("function identifyObjectsFromImagesUsingMobileNet ##########");
    ...
    async function getWordFromIdentifiedObjects(identifiedObjectsList) {
        //console.info("function getWordFromIdentifiedObjects ##########");

        //console.debug("identifiedObjectsList: " + identifiedObjectsList);
    ...
    function inputChallenge(data, imageUrl) {
        //console.info("function inputChallenge ##########");
    ...
    async function identifyWordFromExamples() {
        //console.info("function identifyWordFromExamples ##########");
    ...
    function isObjectChanged() {
        //console.info("function isObjectChanged ##########");

        if (!prevObject && qSelector(PROMPT_TEXT)) {
            prevObject = qSelector(PROMPT_TEXT).innerText;
            //console.debug("prevObject: " + prevObject);
            return true;
        }

        if (prevObject && qSelector(PROMPT_TEXT) &&
            prevObject == qSelector(PROMPT_TEXT).innerText) {
            //console.debug("qSelector(PROMPT_TEXT).innerText: " +qSelector(PROMPT_TEXT).innerText);
            return false;
        }
    ...
    async function identifyWord() {
        //console.info("function identifyWord ##########");

        //console.debug("window.location.href.includes('&hl=en'): " + window.location.href.includes('&hl=en'));
        //console.debug("ENABLE_DEFAULT_LANGUAGE: " + ENABLE_DEFAULT_LANGUAGE);
        //console.debug("DEFAULT_LANGUAGE:" + DEFAULT_LANGUAGE);
        //console.debug("LANG_ENGLISH: " + LANG_ENGLISH);

        var word = -1;
        try {
            if (window.location.href.includes('&hl=en') || (ENABLE_DEFAULT_LANGUAGE && DEFAULT_LANGUAGE == LANG_ENGLISH)) {
                //console.debug("PROMPT_TEXT: " + PROMPT_TEXT);
                //console.debug("qSelector(PROMPT_TEXT): " + qSelector(PROMPT_TEXT));
                //console.debug("qSelector(PROMPT_TEXT).innerText: " + qSelector(PROMPT_TEXT).innerText);
                word = qSelector(PROMPT_TEXT) ? qSelector(PROMPT_TEXT).innerText : word;
                word =word.replaceAll("\u03BF", "o");
                word = word.replaceAll(String.fromCharCode(1072), "a");
                word = word.replaceAll(String.fromCharCode(1089), "c");
                word = word.replaceAll(String.fromCharCode(1110), "i");
                word = word.replaceAll(String.fromCharCode(1109), "s");
                ...
                console.debug("word.replace(): " + word);
                //console.debug("TRANSPORT_TYPES: " + TRANSPORT_TYPES);
                if(TRANSPORT_TYPES.toString().toLowerCase().includes(word) || VERTICAL_RIVER.toString().toLowerCase().includes(word) ){
                    console.log("includ");
                    return word;
                }
                else{
                ...
                //console.debug("VERTICAL_RIVER: " + VERTICAL_RIVER);
                if (word.equalsOneOf(TRANSPORT_TYPES) || word == VERTICAL_RIVER) {
                    console.debug("word.equalsOneOf");
                    return word;
                } else {
    ...
    async function selectImages() {
        //console.info("function selectImages ##########");
        ...
        if (ENABLE_DEFAULT_LANGUAGE) {
            for (let i = 0; i < qSelectorAll(LANGUAGE_SELECTOR).length; i++) {
                if (qSelectorAll(LANGUAGE_SELECTOR)[i].innerText == DEFAULT_LANGUAGE) {
                    ...
                    console.log("clicked " + document.querySelectorAll(LANGUAGE_SELECTOR)[i]);
                    await delay(1000);
                }
            }
        }
        ...
        if (qSelectorAll(IMAGE) && qSelectorAll(IMAGE).length == 9 && qSelector(NO_SELECTION).getAttribute(ARIA_HIDDEN) != true) {
            ...
            try {
                ...
                var word = prevWord;
                console.debug("word = prevWord: " + word);
                ...
                if (word == -1 && skipCount >= MAX_SKIPS) {
                    ...
                    if (qSelector(SUBMIT_BUTTON)) {
                        qSelector(SUBMIT_BUTTON).click();
                        console.debug("clicked: " + qSelector(SUBMIT_BUTTON));
                    }
                    return selectImagesAfterDelay(5);
                } else {
                    //Get Synonyms for the word
                    word = await getSynonyms(word);
                    console.debug("word = getSynonyms(): " + word);
